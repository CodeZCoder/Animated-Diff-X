...
function setupEventListeners() {
    ...
    // Input image preview
    // Input image preview and clear button for image-to-video
    inputImageInput.addEventListener('change', (e) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                if (!document.getElementById('clear-input-image')) {
                    const clearButton = document.createElement('button');
                    clearButton.id = 'clear-input-image';
                    clearButton.className = 'btn btn-sm btn-danger mt-2';
                    clearButton.innerHTML = '<i class="bi bi-x-circle"></i> Remove Image';
                    ...
                    imagePreview.parentNode.appendChild(clearButton);
                }
            };
    ...
    // IP Adapter image preview and clear button
    ipAdapterImageInput.addEventListener('change', (e) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                // Create clear button if it doesn't exist
                if (!document.getElementById('clear-ip-adapter-image')) {
                    const clearButton = document.createElement('button');
                    clearButton.id = 'clear-ip-adapter-image';
                    clearButton.className = 'btn btn-sm btn-danger mt-2';
                    clearButton.innerHTML = '<i class="bi bi-x-circle"></i> Remove Image';
                    clearButton.addEventListener('click', (e) => {
                        e.preventDefault();
                        ipAdapterImageInput.value = '';
                        ipAdapterPreview.classList.add('d-none');
                        ipAdapterPreview.src = '';
                        clearButton.remove();
                    });
                    ipAdapterPreview.parentNode.appendChild(clearButton);
                }
            };
            reader.readAsDataURL(file);
        }
    ...
    // ControlNet image preview and clear button
    controlNetImageInput.addEventListener('change', (e) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                // Create clear button if it doesn't exist
                if (!document.getElementById('clear-controlnet-image')) {
                    const clearButton = document.createElement('button');
                    clearButton.id = 'clear-controlnet-image';
                    clearButton.className = 'btn btn-sm btn-danger mt-2';
                    clearButton.innerHTML = '<i class="bi bi-x-circle"></i> Remove Image';
                    clearButton.addEventListener('click', (e) => {
                        e.preventDefault();
                        controlNetImageInput.value = '';
                        controlNetPreview.classList.add('d-none');
                        controlNetPreview.src = '';
                        clearButton.remove();
                    });
                    controlNetPreview.parentNode.appendChild(clearButton);
                }
            };
            reader.readAsDataURL(file);
        }
