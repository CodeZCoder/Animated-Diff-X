...
def apply_motion_lora(
    motion_module: Dict[str, torch.Tensor],
    motion_lora: Dict[str, torch.Tensor],
    alpha: float = 1.0
) -> Dict[str, torch.Tensor]:
    """
    Apply a Motion LoRA to a motion module
    
    Args:
        motion_module: The motion module state dict
        motion_lora: The motion LoRA state dict
        alpha: The strength of the LoRA effect (0.0 to 1.0)
        
    Returns:
        Updated motion module state dict
    """
