...
class Config:
    ...
    ip_adapter_dir: str = os.path.join(models_dir, "ip_adapter")
    clip_vision_dir: str = os.path.join(models_dir, "clip_vision")
    controlnet_dir: str = os.path.join(models_dir, "controlnet")
    sd15_lora_dir: str = os.path.join(models_dir, "SD_1.5_loras")
    ...
    batch_size: int = 1
    use_cpu: bool = True  # Added for compatibility with app.py
