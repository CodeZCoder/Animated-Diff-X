...
class LivePreviewServer:
    ...
    def register_socket_events(self):
        ...
        def handle_start_generation(data):
            ...
            try:
                ...
                self.preview_manager.start_generation(generation_id, num_inference_steps)
    ...
    def _run_generation(
        ...
        try:
            ...
            def preview_callback(frame, step, total_steps):
                self.preview_manager.update_preview(frame, step, total_steps)
