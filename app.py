...
if __name__ == '__main__':
    ...
    if initialization_success and preview_server is not None:
        # Use the preview server if it was successfully initialized
        preview_server.run(host=args.host, port=args.port, debug=args.debug)
    else:
        # Fall back to basic Socket.IO if preview server initialization failed
